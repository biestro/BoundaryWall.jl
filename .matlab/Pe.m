...
index_paridad=-(real(z/exp(1i*zf))<0)+(real(z/exp(1i*zf))>=0) % Vector para despues para obtener los valores negativos de la derivada
...
for j=1:nca
    ...
    [yin,ypin]=yo_parabolic(yi,xo*exp(1i*zf),   a,zi*exp(i*zf));
